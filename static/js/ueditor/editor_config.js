...
var UEDITOR_CONFIG = {
    ...
    toolbars: [
        ['FullScreen','Source','|','Undo','Redo','|',
         ...
         'Link','Unlink','Anchor','Image','MultiMenu','Video','Map','GMap','InsertFrame', 'PageBreak','Code','|',
...
//        'tablesuper': '表格高级设置',
    ...
    iframeUrlMap: {
        ...
        'image': '/static/js/ueditor/dialogs/image/image.html',
    ...
    defaultFontSize:"16px",                              //默认字号
    defaultFontFamily:"宋体",                            //默认字体
