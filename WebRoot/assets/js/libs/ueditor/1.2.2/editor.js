...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            ['Bold', 'Underline', 'StrikeThrough', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'Link', 'Unlink', 'PageBreak', 'Anchor', 'InsertOrderedList', 'InsertUnorderedList', 'Source']
        ]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{
            'bold':'加粗','underline':'下划线','strikethrough':'删除线','justifyleft':'居左对齐','justifycenter':'居中对齐','justifyright':'居右对齐','link':'插入链接','unlink':'取消链接','pagebreak':'插入分页符','anchor':'插入锚点','insertorderedlist':'插入有序列表','insertunorderedlist':'插入无序列表','source':'切换源码'
        }
